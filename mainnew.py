	...
	def fetch_room(self, simulation_id):
		try:
			...
			if(simulation_id == '87'):
				...
				result = """
				<img src='assets/blueprints/bungalow1.png' usemap="#image-map">

				<map name="image-map">
				    <area id="outdoorLivingLeft" class="droptarget" data-bs-toggle="modal" data-bs-target="#modal1" alt="dining-ketchen1" title="dining-ketchen1"  coords="232,190,61,297" shape="rect">
				 ...
				 <div class="row mt-3">
				    <div class="col-6 room red-door-color">Outdoor Dining Area
				        ...
				        <!-- Bootstrap Modal -->
					<div class="modal fade" id="modal1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog modal-dialog-centered " role="document"  >
					        <div class="modal-content">
					            <div class="modal-header">
					                <h5 class="modal-title" id="exampleModalLabel">Outdoor Dining Area</h5>

					                <div style="width:100px" class="row">
					          <img src="delete.png" style="margin: auto; width: 35px!important;" class="droptarget" id="delete"
                            style="width:45px;height:45px;border:none!important;"> 
